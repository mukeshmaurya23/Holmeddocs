  ...
  return (
    <>
      <div className="flex mb-10 flex-col lg:flex-row  xl:flex-row md:justify-center md:items-center max-w-full">
        <div>
          <h2 className="2xl:mr-[8rem] font-sansRegular font-semibold text-[#292F33] tracking-[4px] mb-4  text-[1.4rem] md:text-[2.5rem] sm:text-[2.2] sm:text-center xs:text-center xsm:text-center ">
            Our Process
          </h2>
          <img
            src={ourProcess}
        ...
        <div className="py-7 md:py-16 sm:py-16 lg:py-16 xl:py-16 2xl:py-16  flex-1">
          <h2 className="px-24 font-sansRegular text-[1rem] md:text-[1.7rem]  sm:text-[1.5rem] xl:text-[1.9rem] 2xl:text-[2rem] text-gray-800   xl:leading-[3rem] pb-3 text-center md:text-left ">
            Instant appointment with Holistic Practitioners
          </h2>
          <p className="text-[#545871] text-[.8rem] md:text-[1.1rem] px-24  text-center md:text-left">
          ...
          <div className="flex justify-evenly cursor-pointer w-[85%]  mt-10 sm:flex-col sm:items-center xs:flex-col xs:items-center xsm:flex-col xsm:items-center md:flex-row md:items-start lg:flex-row lg:items-start ">
            <div className="flex flex-col   sm:items-center xs:items-center xsm:items-center sm:space-y-3 sm:mb-2 xsm:space-y-2 xs:space-y-3">
              ...
              <div className="py-4">
                ...
                <p className="text-[#292F33] text-[1rem] py-2 text-center font-semibold font-sansRegular sm:hidden lg:block md:block xl:block">
                  Practitioners
                </p>
              </div>
            ...
            <div className="flex flex-col sm:items-center xs:items-center xsm:items-center sm:space-y-3 xsm:space-y-2 xs:space-y-3 sm:mb-2 ">
              ...
              <img
                ...
                className="w-[50px] mt-2 h-[100px] md:w-[70px] sm:w-[70px] lg:w-[70px] xl:w-[70px] 2xl:w-[70px]"
              />
              <p className="text-[#292F33] text-[1rem] font-semibold font-sansRegular py-8">
                Book appointment
              </p>
            </div>
            <div className="sm:hidden xs:hidden xsm:hidden lg:block md:block xl:block 2xl:block border-l h-[300px] border-gray-300"></div>
