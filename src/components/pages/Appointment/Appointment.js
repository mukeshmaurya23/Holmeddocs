...
const Appointment = () => {
  ...
  const [appointmnetDataResultList, setAppointmnetDataResultList] = useState(
    []
  );
  ...
  const fetchData = async (page) => {
    try {
      ...
      //  setAppointmnetDataResultList(response?.data?.data?.result);
      const newDoctors = response?.data?.data?.result;
      setLoading(false);
      if (newDoctors.length > 0) {
        setAppointmnetDataResultList((prevData) => [
          ...prevData,
          ...newDoctors,
        ]);
  ...
  console.log(appointmnetDataResultList, "appointmnetDataResult my datataaaaa");
  ...
  return (
    <>
      ...
      {loading ? (
      ...
      ) : currentPage === 1 && appointmentData.data.result?.length === 0 ? (
        ...
        <div className="flex  h-[100vh] ">
          <div className=" w-full md:w-[25%] bg-appointmentColor">
            ...
            <div className="hidden md:block lg:block h-[calc(100vh_-_4rem)] overflow-y-auto ">
              {isSidebarOpen ? (
                <>
                  {/*  {currentIndex} */}
                  ...
                  {isSidebarOpenForSchedule && (
                    <InfiniteScroll
                      dataLength={appointmnetDataResultList?.length}
                      threshold={20}
                    ...
                    >
                      <>
                        {appointmnetDataResultList &&
                          appointmnetDataResultList?.map((data, index) => {
                            return (
                              <div
            ...
            {!initialMobileState ? (
              ...
              <div className=" block md:hidden flex-1 bg-white">
                <div className="flex flex-col border-b lg:p-5 border-gray-300 ">
                  {appointmnetDataResultList &&
                    appointmnetDataResultList?.map((item) => {
