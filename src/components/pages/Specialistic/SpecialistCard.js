...
//   console.log(selectedItemList, "im selected item list");
...
//             <div
//               className="flex flex-col items-center md:items-start justify-center sm:items-center 2xl:
//               rounded-3xl pt-6 md:pl-6 2xl:pl-0   hover:border-[#b4dbd5] hover:shadow-xl border-2 border-white hover:cursor-pointer  md:max-w-[20rem] "
//               key={index}
