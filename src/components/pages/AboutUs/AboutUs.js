    ...
    <div className="overflow-hidden max-w-[1560px] mx-auto">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 px-2 md:px-10 py-2 space-y-4 mb-10">
        ...
        <div className="px-4 md:px-16">
          ...
          <h2 className="text-[#292F33] font-sansBold text-[1.3rem] md:text-[1.8rem] tracking-[2px]">
            Know about Holmeddoc
          </h2>
          <p className="text-[#545871] text-[.8em] md:text-[.9rem] tracking-tight  mt-7 font-sansRegular">
        ...
        <div className="flex flex-col sm:flex-row justify-evenly items-center mr-5 py-10 p-5">
          {ApproacData.map((data) => (
            <div className="flex flex-col items-center justify-center mb-10 cursor-pointer">
              ...
              <p className="text-[#545871] font-sansRegular text-[.9rem] mt-2 text-center px-10 py-2 max-w-[370px] md:max-w-[400px]">
                {data.description}
              </p>
            </div>
          ))}
        ...
        <div className="flex justify-evenly flex-col md:flex-row">
          {StrengthData.map((data) => (
            <div className="flex flex-col items-center justify-center mb-10">
              ...
              />
              <h1 className="text-[#292F33] font-sansBold text-[1.2rem] tracking-[2px] mt-4">
                {data.name}
              </h1>
              <h1 className="text-[#545871] font-sansRegular text-[.9rem] tracking-[2px] mt-2">
                {data.designation}
              </h1>
            </div>
          ))}
